...
- Category Scope: Your chosen categories become the top-level folders, while AI continues to infer relevant subcategories and deeper folder levels within each one.
...
3. Design: The AI reviews your collection and creates a clean folder layout. Your chosen categories are used as the top-level folders; deeper subcategories and folder levels are inferred from your bookmarks.
